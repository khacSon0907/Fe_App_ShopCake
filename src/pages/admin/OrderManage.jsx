...
export default function OrderManage() {
  ...
  const [newStatus, setNewStatus] = useState(""); // Thêm state riêng cho trạng thái mới
  ...
  const handleEditStatus = (order) => {
    setSelectedOrder(order);
    setNewStatus(order.status); // Set trạng thái hiện tại làm mặc định
    setEditDialogOpen(true);
  };

  // Hàm kiểm tra trạng thái có thể chuyển đổi
  ...
  const handleUpdateStatus = async () => {
    ...
    if (currentStatus === "COMPLETED") {
      alert("Đơn hàng đã hoàn tất không thể cập nhật trạng thái.");
      return;
    }
    ...
    if (newStatus !== currentStatus && 
      ...
      alert("Không thể chuyển từ trạng thái hiện tại sang trạng thái được chọn.");
      return;
    }
          ...
          <Grid container spacing={3} mb={4}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Card
                sx={{
                  background:
                    "linear-gradient(45deg, #4ECDC4 30%, #6EE7E0 90%)",
                }}
              >
                <CardContent>
                  <Box
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Card
                sx={{
                  background:
                    "linear-gradient(45deg, #45B7D1 30%, #67C5E0 90%)",
                }}
              >
                <CardContent>
                  <Box
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Card
                sx={{
                  background:
                    "linear-gradient(45deg, #96CEB4 30%, #B3DBC7 90%)",
                }}
              >
                <CardContent>
                  <Box
          ...
          {selectedOrder && (
            <Box mt={2}>
              <Typography variant="body2" color="text.secondary" mb={2}>
                Trạng thái hiện tại: <strong>{getStatusText(selectedOrder.status)}</strong>
              </Typography>
              <FormControl fullWidth>
